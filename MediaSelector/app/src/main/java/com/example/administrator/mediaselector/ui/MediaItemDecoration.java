package com.example.administrator.mediaselector.ui;
...
/**
 * the space of each media items{@link com.moos.media.entity.BaseMediaEntity } for rv
 *
 * @author moosphon
 */
public class MediaItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public MediaItemDecoration(int space, int spanCount) {
        this.mSpace = space;
